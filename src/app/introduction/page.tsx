      ...
      <div className="flex flex-col p-16">
        <p>
          {`Hey there! 👋 I'm Deniz, a passionate Senior Frontend Software Engineer currently bringing ideas to life at Crea Inc. 
            ...
            My journey in tech started in Ankara, where I pursued a degree in Computer Engineering at Hacettepe University 🎓`}
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          {`When I'm not coding or brainstorming my next big idea, you can find me out in nature, 🏕️ camping under the stars, or ✈️ traveling 
